 ...
 * 2024-06-11T16:09:08.596+05:30
 * Generated source version: 3.5.0
 *
 */
@WebServiceClient(name = "Calculator",
                  wsdlLocation = "file:/D:/Projects/intelij-camel-project/SoapCalculatorJavaDSL/src/main/resources/calculator.wsdl",
...
public class Calculator extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/Projects/intelij-camel-project/SoapCalculatorJavaDSL/src/main/resources/calculator.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Calculator.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/Projects/intelij-camel-project/SoapCalculatorJavaDSL/src/main/resources/calculator.wsdl");
        }
        WSDL_LOCATION = url;
    }
