 ...
 * 2024-02-19T10:01:41.958+05:30
 * Generated source version: 3.5.0
 *
 */
@WebServiceClient(name = "Calculator",
                  wsdlLocation = "file:/E:/Projects/stsworkspace/SoapCalculator/src/main/resources/calculator.wsdl",
...
public class Calculator extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/Projects/stsworkspace/SoapCalculator/src/main/resources/calculator.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Calculator.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/E:/Projects/stsworkspace/SoapCalculator/src/main/resources/calculator.wsdl");
        }
        WSDL_LOCATION = url;
    }
